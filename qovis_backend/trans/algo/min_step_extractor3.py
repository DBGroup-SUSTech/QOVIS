...
class MinStepExtractor3:
    ...
    def search_reorder_transform_path(self, start: QueryPlan) -> Optional[tuple[QueryPlan, list[Rule]]]:
        ...
        path_dict[start] = []
        open_q.put(PrioritizedItem(start, src_f, 0))
        open_set[start] = None
            ...
            for rule in self.reorder_rules:
                ...
                for new_t in new_ts:
                    ...
                    if new_t not in open_set:
                        ...
                        f = g + h
                        # add to open set
                        open_q.put(PrioritizedItem(new_t, f, 0))
                        open_set[new_t] = None
    ...
    def search_normal_transform_path(self, start: QueryPlan) -> Optional[list[Rule]]:
        ...
        src_hu = self.get_delta_dist(start, self.t_dst)
        ...
        path_dict[start] = []
        open_q.put(PrioritizedItem(start, src_f, src_hu))
        open_set[start] = None
